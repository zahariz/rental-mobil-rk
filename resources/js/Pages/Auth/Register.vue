      ...
      <div class="w-full max-w-md">
        ...
        <form class="mt-8 bg-white rounded-lg shadow-xl overflow-hidden" @submit.prevent="register">
          <div class="px-10 py-12">
            ...
            <text-input v-model="form.name" :error="form.errors.name" class="mt-10" label="Name" />
          ...
          <div class="flex items-center justify-between px-10 py-4 bg-gray-100 border-t border-gray-100">
            <span class="text-sm">Already have an account? <a href="/login" class="underline hover:text-indigo-400" >Login</a> </span>
