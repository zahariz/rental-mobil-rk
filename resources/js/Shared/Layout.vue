      ...
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-indigo-900 md:shrink-0 md:justify-center md:w-56">
            <Link class="mt-1 flex items-center justify-between" href="/">
              <logo class="fill-white" width="120" height="28" />
              <span class="text-white font-bold hidden md:inline">RK</span>w
            </Link>
            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  ...
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" v-if="auth.user.role == 'Admin'" href="/users">Manage Users</Link>
